...
@SlingServletResourceTypes(
        ...
        resourceTypes = "aemproject/components/structure/page",
        selectors = {"project","test"},
        extensions = {"txt","xml"}
)
public class ProjectResourceTypesServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(ProjectResourceTypesServlet.class);
