...
@Exporter(name = "jackson", extensions ="json",selector = "project",
        options = {
...
public class AuthorImpl implements Author{
    ...
    final protected static String RESOURCE_TYPE="aemproject/components/content/author";
    ...
    @ResourcePath(path="/content/aemproject/us/en/home")@Via("resource")
