...
import com.aem.project.core.models.ComponentInfo;
import com.aem.project.core.services.ComponentsInfoService;
import com.aem.project.core.utils.Constants;
...
public class ComponentInfoImpl implements ComponentInfo {
    ...
    public List<Map<String, String>> getComponents() {
    	return componentsInfoService.getComponents("/apps/aemproject");
    }
