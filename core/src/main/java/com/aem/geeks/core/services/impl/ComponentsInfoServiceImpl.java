...
@Component(immediate = true, service = ComponentsInfoService.class, name = "com.aem.project.core.services.ComponentsInfo", configurationPid = "com.aem.project.core.services.impl.ComponentsInfoImpl",
		property = {
