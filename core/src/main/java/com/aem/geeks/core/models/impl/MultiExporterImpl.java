...
import com.aem.project.core.models.MultiExporter;
import com.aem.project.core.models.XmlExporter;
...
@Exporters({
        @Exporter(name = "jackson",extensions = "json",selector = "projectjson",
        options = {
                @ExporterOption(name = "SerializationFeature.WRAP_ROOT_VALUE", value="true")
        }),
        @Exporter(name = "projectxml",extensions = "xml",selector = "projectxml")
})
@Model(
...
public class MultiExporterImpl implements MultiExporter {
    static final String RESOURCE_TYPE="aemproject/components/content/multiexporter";
