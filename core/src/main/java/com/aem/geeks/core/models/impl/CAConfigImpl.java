package com.aem.project.core.models.impl;

import com.aem.project.core.config.ProjectCAConfig;
import com.aem.project.core.models.CAConfig;
...
public class CAConfigImpl implements CAConfig {
    ...
    protected static final String RESOURCE_TYPE = "aemproject/components/content/card";
    ...
    private ProjectCAConfig projectCAConfig;
    ...
    ProjectCAConfig caConfig=getContextAwareConfig(currentPage.getPath(),resourceResolver);
    ...
    public ProjectCAConfig getContextAwareConfig(String currentPage, ResourceResolver resourceResolver) {
        ...
        if (contentResource != null) {
           ConfigurationBuilder configurationBuilder = contentResource.adaptTo(ConfigurationBuilder.class);
            if (configurationBuilder != null) {
                return configurationBuilder.as(ProjectCAConfig.class);
            }
        }
        return null;
    }
