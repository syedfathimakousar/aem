...
import java.util.*;
@Exporter(name = "projectxml",extensions = "xml",selector = "project")
@Model(
...
@XmlRootElement(name = "project-exporter")
public class XmlExporterImpl implements XmlExporter {
    static final String RESOURCE_TYPE="aemproject/components/content/xmlexporter";
