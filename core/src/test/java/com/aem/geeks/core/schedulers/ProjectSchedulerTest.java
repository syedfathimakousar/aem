...
class ProjectSchedulerTest {
    ...
    private ProjectScheduler schedulerTest;
    ...
    @BeforeEach
    void setUp() {
        schedulerTest=aemContext.registerService(new ProjectScheduler());
        LOG=TestLoggerFactory.getTestLogger(schedulerTest.getClass());
        schedulerConfiguration=mock(SchedulerConfiguration.class);
        when(schedulerConfiguration.schedulerName()).thenReturn("Project Scheduler");
...
/*
    ...
    void run() {
        ...
        assertEquals(schedulerConfiguration.schedulerName(),"Project Scheduler");
    }
*/
